...
public final class GetDestinationFingerprintsFingerprint extends com.pulumi.resources.InvokeArgs {

    public static final GetDestinationFingerprintsFingerprint Empty = new GetDestinationFingerprintsFingerprint();
    ...
    private GetDestinationFingerprintsFingerprint() {}

    private GetDestinationFingerprintsFingerprint(GetDestinationFingerprintsFingerprint $) {
        this.hash = $.hash;
    ...
    public static Builder builder(GetDestinationFingerprintsFingerprint defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDestinationFingerprintsFingerprint();
        }

        public Builder(GetDestinationFingerprintsFingerprint defaults) {
            $ = new GetDestinationFingerprintsFingerprint(Objects.requireNonNull(defaults));
        }
        ...
        public GetDestinationFingerprintsFingerprint build() {
