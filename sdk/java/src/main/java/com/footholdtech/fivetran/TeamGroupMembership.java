...
import com.footholdtech.fivetran.TeamGroupMembershipArgs;
import com.footholdtech.fivetran.Utilities;
import com.footholdtech.fivetran.inputs.TeamGroupMembershipState;
import com.footholdtech.fivetran.outputs.TeamGroupMembershipGroup;
 ...
 * 
 */
@ResourceType(type="fivetran:index/teamGroupMembership:TeamGroupMembership")
public class TeamGroupMembership extends com.pulumi.resources.CustomResource {
    @Export(name="groups", refs={List.class,TeamGroupMembershipGroup.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TeamGroupMembershipGroup>> groups;

    public Output<Optional<List<TeamGroupMembershipGroup>>> groups() {
     ...
     */
    public TeamGroupMembership(String name) {
        this(name, TeamGroupMembershipArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public TeamGroupMembership(String name, TeamGroupMembershipArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("fivetran:index/teamGroupMembership:TeamGroupMembership", name, args == null ? TeamGroupMembershipArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TeamGroupMembership(String name, Output<String> id, @Nullable TeamGroupMembershipState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("fivetran:index/teamGroupMembership:TeamGroupMembership", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static TeamGroupMembership get(String name, Output<String> id, @Nullable TeamGroupMembershipState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
