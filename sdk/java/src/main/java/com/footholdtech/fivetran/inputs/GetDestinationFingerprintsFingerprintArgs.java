...
public final class GetDestinationFingerprintsFingerprintArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetDestinationFingerprintsFingerprintArgs Empty = new GetDestinationFingerprintsFingerprintArgs();
    ...
    private GetDestinationFingerprintsFingerprintArgs() {}

    private GetDestinationFingerprintsFingerprintArgs(GetDestinationFingerprintsFingerprintArgs $) {
        this.hash = $.hash;
    ...
    public static Builder builder(GetDestinationFingerprintsFingerprintArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDestinationFingerprintsFingerprintArgs();
        }

        public Builder(GetDestinationFingerprintsFingerprintArgs defaults) {
            $ = new GetDestinationFingerprintsFingerprintArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDestinationFingerprintsFingerprintArgs build() {
