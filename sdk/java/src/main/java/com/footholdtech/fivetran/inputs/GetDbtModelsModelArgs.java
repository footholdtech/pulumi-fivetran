...
public final class GetDbtModelsModelArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetDbtModelsModelArgs Empty = new GetDbtModelsModelArgs();
    ...
    private GetDbtModelsModelArgs() {}

    private GetDbtModelsModelArgs(GetDbtModelsModelArgs $) {
        this.id = $.id;
    ...
    public static Builder builder(GetDbtModelsModelArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDbtModelsModelArgs();
        }

        public Builder(GetDbtModelsModelArgs defaults) {
            $ = new GetDbtModelsModelArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDbtModelsModelArgs build() {
