...
public final class GetGroupUsersUser extends com.pulumi.resources.InvokeArgs {

    public static final GetGroupUsersUser Empty = new GetGroupUsersUser();
    ...
    private GetGroupUsersUser(GetGroupUsersUser $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGroupUsersUser();
        }

        public Builder(GetGroupUsersUser defaults) {
            $ = new GetGroupUsersUser(Objects.requireNonNull(defaults));
        }
