...
@CustomType
public final class ConnectorFingerprintsFingerprint {
    /**
    ...
    public static Builder builder(ConnectorFingerprintsFingerprint defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String validatedDate;
        public Builder() {}
        public Builder(ConnectorFingerprintsFingerprint defaults) {
        ...
        public ConnectorFingerprintsFingerprint build() {
            final var o = new ConnectorFingerprintsFingerprint();
            o.hash = hash;
