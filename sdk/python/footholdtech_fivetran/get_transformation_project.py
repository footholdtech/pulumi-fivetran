...
def get_transformation_project(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The unique identifier for the transformation Project within the Fivetran system.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_transformation_project_output(id: Optional[pulumi.Input[builtins.str]] = None,
