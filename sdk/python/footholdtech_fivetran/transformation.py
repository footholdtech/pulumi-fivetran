...
class TransformationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] paused: The field indicating whether the transformation will be set into the paused state. By default, the value is false.
        :param pulumi.Input[builtins.str] type: Transformation type. The following values are supported: DBT_CORE, QUICKSTART.
        """
...
class _TransformationState:
    def __init__(__self__, *,
                 ...
                 output_model_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 paused: Optional[pulumi.Input[builtins.bool]] = None,
                 schedule: Optional[pulumi.Input['TransformationScheduleArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] created_at: The timestamp of when the transformation was created in your account.
        :param pulumi.Input[builtins.str] created_by_id: The unique identifier for the User within the Fivetran system who created the transformation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] output_model_names: Identifiers of related models.
        :param pulumi.Input[builtins.bool] paused: The field indicating whether the transformation will be set into the paused state. By default, the value is false.
        :param pulumi.Input[builtins.str] status: Status of transformation Project (NOT_READY, READY, ERROR).
        :param pulumi.Input[builtins.str] type: Transformation type. The following values are supported: DBT_CORE, QUICKSTART.
        """
    ...
    def output_model_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def output_model_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Transformation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="outputModelNames")
    def output_model_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Identifiers of related models.
        """
        return pulumi.get(self, "output_model_names")
