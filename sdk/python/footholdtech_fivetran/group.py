...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the group within your account.
        """
        if name is not None:
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The timestamp of when the group was created in your account.
        :param pulumi.Input[builtins.str] last_updated: The timestamp of when the resource/datasource was updated last time.
        :param pulumi.Input[builtins.str] name: The name of the group within your account.
        """
