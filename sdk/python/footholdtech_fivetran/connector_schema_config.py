...
class ConnectorSchemaConfigArgs:
    def __init__(__self__, *,
                 ...
                 schemas_json: Optional[pulumi.Input[builtins.str]] = None,
                 timeouts: Optional[pulumi.Input['ConnectorSchemaConfigTimeoutsArgs']] = None,
                 validation_level: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] validation_level: The value defines validation method. - NONE: no validation, any configuration accepted. - TABLES: validate table names,
    ...
    def schema_change_handling(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def schema_change_handling(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def schemas_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @schemas_json.setter
    def schemas_json(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def validation_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def validation_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConnectorSchemaConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schemas_json: Optional[pulumi.Input[builtins.str]] = None,
            timeouts: Optional[pulumi.Input[Union['ConnectorSchemaConfigTimeoutsArgs', 'ConnectorSchemaConfigTimeoutsArgsDict']]] = None,
            validation_level: Optional[pulumi.Input[builtins.str]] = None) -> 'ConnectorSchemaConfig':
        """
    ...
    @property
    @pulumi.getter(name="schemaChangeHandling")
    def schema_change_handling(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The value specifying how new source data is handled.
        """
        return pulumi.get(self, "schema_change_handling")
    ...
    @property
    @pulumi.getter(name="schemasJson")
    def schemas_json(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Schema settings in Json format, following Fivetran API endpoint contract for `schemas` field (a map of schemas).
        """
        return pulumi.get(self, "schemas_json")
    ...
    @property
    @pulumi.getter(name="validationLevel")
    def validation_level(self) -> pulumi.Output[builtins.str]:
        """
        The value defines validation method. - NONE: no validation, any configuration accepted. - TABLES: validate table names,
        fail on attempt to configure non-existing schemas/tables. - COLUMNS: validate the whole schema config including column
        names. The resource will try to fetch columns for every configured table and verify column names.
