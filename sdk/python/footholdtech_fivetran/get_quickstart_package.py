...
class GetQuickstartPackageResult:
    ...
    def connector_types(self) -> Sequence[builtins.str]:
        """
...
def get_quickstart_package(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The unique identifier for the Quickstart transformation package definition within the Fivetran system
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_quickstart_package_output(id: Optional[pulumi.Input[builtins.str]] = None,
