...
class WebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] active: Boolean, if set to true, webhooks are immediately sent in response to events
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: The array of event types
        :param pulumi.Input[builtins.str] secret: The secret string used for payload signing and masked in the response.
        :param pulumi.Input[builtins.str] type: The webhook type (group, account)
        :param pulumi.Input[builtins.str] url: Your webhooks URL endpoint for your application
        :param pulumi.Input[builtins.str] group_id: The group ID
        :param pulumi.Input[builtins.bool] run_tests: Specifies whether the setup tests should be run
        """
...
class _WebhookState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] active: Boolean, if set to true, webhooks are immediately sent in response to events
        :param pulumi.Input[builtins.str] created_at: The webhook creation timestamp
        :param pulumi.Input[builtins.str] created_by: The ID of the user who created the webhook.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: The array of event types
        :param pulumi.Input[builtins.str] group_id: The group ID
        :param pulumi.Input[builtins.bool] run_tests: Specifies whether the setup tests should be run
        :param pulumi.Input[builtins.str] secret: The secret string used for payload signing and masked in the response.
...
class Webhook(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="runTests")
    def run_tests(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the setup tests should be run
        """
        return pulumi.get(self, "run_tests")
