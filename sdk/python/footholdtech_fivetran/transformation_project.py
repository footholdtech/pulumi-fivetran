...
class TransformationProjectArgs:
    def __init__(__self__, *,
                 ...
                 run_tests: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] type: Transformation project type.
        :param pulumi.Input[builtins.bool] run_tests: Specifies whether the setup tests should be run automatically. The default value is TRUE.
        """
    ...
    def run_tests(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @run_tests.setter
    def run_tests(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _TransformationProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The timestamp of the transformation Project creation.
        :param pulumi.Input[builtins.str] created_by_id: The unique identifier for the User within the Fivetran system who created the dbt Project.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] errors: List of environment variables defined as key-value pairs in the raw string format using = as a separator. The variable name should have the DBT_ prefix and can contain A-Z, 0-9, dash, underscore, or dot characters. Example: "DBT*VARIABLE=variable*value"
        :param pulumi.Input[builtins.str] group_id: The unique identifier for the group within the Fivetran system.
        :param pulumi.Input[builtins.bool] run_tests: Specifies whether the setup tests should be run automatically. The default value is TRUE.
...
class TransformationProject(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            run_tests: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'TransformationProject':
        """
    ...
    @property
    @pulumi.getter(name="runTests")
    def run_tests(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether the setup tests should be run automatically. The default value is TRUE.
        """
        return pulumi.get(self, "run_tests")
