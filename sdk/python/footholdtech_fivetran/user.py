...
class UserArgs:
    def __init__(__self__, *,
                 ...
                 invited: Optional[pulumi.Input[builtins.bool]] = None,
                 phone: Optional[pulumi.Input[builtins.str]] = None,
                 picture: Optional[pulumi.Input[builtins.str]] = None,
                 role: Optional[pulumi.Input[builtins.str]] = None,
                 verified: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a User resource.
        :param pulumi.Input[builtins.str] email: The email address that the user has associated with their user profile.
        :param pulumi.Input[builtins.str] family_name: The last name of the user.
        :param pulumi.Input[builtins.str] given_name: The first name of the user.
        :param pulumi.Input[builtins.bool] invited: The field indicates whether the user has been invited to your account.
        :param pulumi.Input[builtins.str] phone: The phone number of the user.
        :param pulumi.Input[builtins.str] picture: The user's avatar as a URL link (for example, 'http://mycompany.com/avatars/john_white.png') or base64 data URI (for example, 'data:image/png;base64,aHR0cDovL215Y29tcGFueS5jb20vYXZhdGFycy9qb2huX3doaXRlLnBuZw==')
        :param pulumi.Input[builtins.str] role: The role that you would like to assign to the user.
        :param pulumi.Input[builtins.bool] verified: The field indicates whether the user has verified their email address in the account creation process.
        """
    ...
    @property
    @pulumi.getter
    def invited(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @invited.setter
    def invited(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def picture(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @picture.setter
    def picture(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _UserState:
    def __init__(__self__, *,
                 ...
                 invited: Optional[pulumi.Input[builtins.bool]] = None,
                 logged_in_at: Optional[pulumi.Input[builtins.str]] = None,
                 phone: Optional[pulumi.Input[builtins.str]] = None,
                 picture: Optional[pulumi.Input[builtins.str]] = None,
                 role: Optional[pulumi.Input[builtins.str]] = None,
                 verified: Optional[pulumi.Input[builtins.bool]] = None):
        ...
        :param pulumi.Input[builtins.str] created_at: The timestamp that the user created their Fivetran account.
        :param pulumi.Input[builtins.str] email: The email address that the user has associated with their user profile.
        :param pulumi.Input[builtins.str] family_name: The last name of the user.
        :param pulumi.Input[builtins.str] given_name: The first name of the user.
        :param pulumi.Input[builtins.bool] invited: The field indicates whether the user has been invited to your account.
        :param pulumi.Input[builtins.str] logged_in_at: The last time that the user has logged into their Fivetran account.
        :param pulumi.Input[builtins.str] phone: The phone number of the user.
        :param pulumi.Input[builtins.str] picture: The user's avatar as a URL link (for example, 'http://mycompany.com/avatars/john_white.png') or base64 data URI (for example, 'data:image/png;base64,aHR0cDovL215Y29tcGFueS5jb20vYXZhdGFycy9qb2huX3doaXRlLnBuZw==')
        :param pulumi.Input[builtins.str] role: The role that you would like to assign to the user.
        :param pulumi.Input[builtins.bool] verified: The field indicates whether the user has verified their email address in the account creation process.
    ...
    @property
    @pulumi.getter(name="familyName")
    def family_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The last name of the user.
        """
        return pulumi.get(self, "family_name")
    ...
    @family_name.setter
    def family_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "family_name", value)
    ...
    def logged_in_at(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @logged_in_at.setter
    def logged_in_at(self, value: Optional[pulumi.Input[builtins.str]]):
...
class User(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            picture: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            verified: Optional[pulumi.Input[builtins.bool]] = None) -> 'User':
        """
    ...
    @property
    @pulumi.getter(name="familyName")
    def family_name(self) -> pulumi.Output[builtins.str]:
        """
        The last name of the user.
        """
        return pulumi.get(self, "family_name")
    ...
    @property
    @pulumi.getter(name="givenName")
    def given_name(self) -> pulumi.Output[builtins.str]:
        """
        The first name of the user.
        """
        return pulumi.get(self, "given_name")
    ...
    @property
    @pulumi.getter
    def invited(self) -> pulumi.Output[builtins.bool]:
        """
        The field indicates whether the user has been invited to your account.
        """
        return pulumi.get(self, "invited")
    ...
    @property
    @pulumi.getter(name="loggedInAt")
    def logged_in_at(self) -> pulumi.Output[builtins.str]:
        """
        The last time that the user has logged into their Fivetran account.
        """
        return pulumi.get(self, "logged_in_at")
    ...
    @property
    @pulumi.getter
    def picture(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user's avatar as a URL link (for example, 'http://mycompany.com/avatars/john_white.png') or base64 data URI (for example, 'data:image/png;base64,aHR0cDovL215Y29tcGFueS5jb20vYXZhdGFycy9qb2huX3doaXRlLnBuZw==')
        """
        return pulumi.get(self, "picture")
