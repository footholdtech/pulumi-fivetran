module github.com/footholdtech/pulumi-fivetran/provider

go 1.21

require (
	github.com/fivetran/terraform-provider-fivetran v1.1.26
...
require (
	...
	github.com/fivetran/go-fivetran v0.8.6 // indirect
