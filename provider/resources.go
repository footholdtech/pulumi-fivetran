...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			// 	Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getTeamConnectorMemberships")
			// },
			// "fivetran_team_group_memberships": {
			// 	Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getTeamGroupMemberships")
			// },
			// "fivetran_team_user_memberships": {
			// 	Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getTeamUserMemberships")
			// },
		},
